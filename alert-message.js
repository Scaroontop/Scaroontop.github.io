(function() {
    ...
    const INITIAL_MESSAGES = [
        ...
        { text: "Keep in mind that Securly classroom can detect about:blank so it may get closed if the teacher is viewing students screens.", style: "font-size: 14px; color: #4b5563;" },
